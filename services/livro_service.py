...
class LivroService:
    @staticmethod
    def criar_livro(titulo, isbn, genero, data_publicacao_str, qtd_paginas, estoque):
        ...
        if data_publicacao_str == None or data_publicacao_str.strip() == "":
            raise AppError("Erro: data de publicação nula ou vazia.")
    ...
    @staticmethod
    def atualizar_livro(id, titulo=None, isbn=None, genero=None, data_publicacao_str=None, qtd_paginas=None, estoque=None):
        ...
        if estoque and estoque < 0:
            raise AppError("Erro: estoque menor que 0.")
        livro.titulo = titulo or livro.titulo
        livro.isbn = isbn or livro.isbn
        livro.genero = genero or livro.genero
        livro.qtd_paginas = qtd_paginas or livro.qtd_paginas
